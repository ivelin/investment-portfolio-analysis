"""Interactive Brokers adapter stub (planned)."""
...
class IbkrBrokerAdapter:
    """IBKR placeholder — export path reserved; fund feeds not implemented."""
    ...
    def __init__(self, *, exports_dir: Path | str | None = None) -> None:
        self.exports_dir = (
            ...
            if exports_dir
            else broker_exports_dir("ibkr")
        )

    def list_accounts(self) -> Sequence[FundAccount]:
        raise NotImplementedError(
            "IBKR adapter is planned; place exports under "
    ...
    def equity_snapshots(
        ...
        *,
        ...
        raise NotImplementedError("IBKR equity snapshots not implemented yet.")
    ...
    def external_cash_flows(
        ...
        *,
        ...
        del account_key, start_date, end_date
        raise NotImplementedError("IBKR external cash flows not implemented yet.")
    ...
    def account_positions(
        ...
        *,
        ...
        raise NotImplementedError("IBKR account positions not implemented yet.")
